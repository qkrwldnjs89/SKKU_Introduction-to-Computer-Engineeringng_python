...
class Game:
    def __init__(self, fps=30):
        ...
        self.background = pygame.transform.scale(pygame.image.load(BG_PATH),
    ...
    def initialize(self):
        self.score = 0
        self.marisa = Marisa(image=MARISA_PATH, size=None, update_ms=60, pos=(150, 150), velocity=(1, 0))
        self.apples = []
        self.mushrooms = []
        ...
        while len(self.apples) < NUM_APPLE:
            ...
            new_apple = GameObject(image=APPLE_PATH,
                                   size=(30, 30),
                                   update_ms=1000,
                                   pos=get_rand_pos(self.window_sz, (128, 128)),
                                   velocity=(0, 0))
    ...
    def game(self):
        ...
        while True:
            ...
            for mushroom in self.mushrooms:
                mushroom.velocity = [   (self.marisa.pos[0] - mushroom.pos[0]) * .002, 
    ...
    def gamestart(self):
        ...
        gameSurf = gameOverFont.render(GAMETITLE, True, WHITE)
        gameRect = gameSurf.get_rect()
        gameRect.midtop = (self.window_width // 2, self.window_height // 2)
